...
import com.hache07.ForoHub.domain.login.DatosAutenticacion;
import com.hache07.ForoHub.domain.usuario.Usuario;
import com.hache07.ForoHub.infra.security.DatosTokenJWT;
import com.hache07.ForoHub.infra.security.TokenService;
...
public class AutenticacionController {
    ...
    public ResponseEntity iniciarSesion(@RequestBody @Valid DatosAutenticacion datos){
        ...
        System.out.println("Autenticación exitosa para: " + datos.login());
